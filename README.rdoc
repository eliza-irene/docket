...
* Authentication & Authorization using Google and Oauth2
...
I want to sign in using my Google credentials</br>
or be able to create a new Google account.</br>
...
And gives me the option to search all events with an optional new </br>location parameter.</br>


As a user</br>
When I click on a day in my calendar,</br>
I want to see a detail version of it </br>
That allows me to add, edit or delete an associated free-time block.</br>


As a user</br>
When I click a free-time block</br>
I want to see all events taking place during that time</br>
And I want to be able to select one to save to my calendar.</br>


As a user</br>
When I click on the free-time button</br>
I want to see a pop-up </br>
...
I want to see that the event appears in my calendar instead of the </br>free-time block.</br>
...
![wireframe2](http://i.imgur.com/1TEzwFZ.jpg) <br />
![wireframe2](http://i.imgur.com/mDYjrQf.jpg) <br />

---

Below is the **ERD** for docket: <br />
![ERD](http://i.imgur.com/DhSf5yD.png?1)
